...
const PATHS: Record<IconName, string> = {
  ...
  book:
    ...
    '<path d="M6.4 9.3c1.2-.2 2.3-.1 3.3.2M6.4 12.5c1.2-.2 2.3-.1 3.3.2" stroke-width="1.7"/>' +
    '<path d="M17.6 9.3c-1.2-.2-2.3-.1-3.3.2M17.6 12.5c-1.2-.2-2.3-.1-3.3.2" stroke-width="1.7"/>',
